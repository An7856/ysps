    ...
    if (request.method === "POST") {
        ...
        try {
            ...
            if (contentType && contentType.includes('application/json')) {
                ...
                if (!currentConfig) currentConfig = { yx: yx, fdc: fdc, uid: uid, dyhd: dyhd, dypz: dypz, dns: dns, protocolConfig: { ev, et, tp }, cfConfig: {}, proxyConfig: {}, klp: 'login', pe: pe, proxyUrl: proxyUrl };
